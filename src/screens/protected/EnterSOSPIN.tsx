...
export default function SOSEnterPIN() {
  ...
  return (
    <ProtectedWrapper backgroundColor={'#214C34'}>
      <View
        style={{
...
const styles = StyleSheet.create({
  ...
  containerStyle: {backgroundColor: '#214C34'},
  pinInputContainerStyle: {backgroundColor: '#214C34'},
  keyboardContainerStyle: {backgroundColor: '#214C34'},
  keyStyle: {
    borderRightWidth: 0,
    borderLeftWidth: 0,
    borderBottomWidth: 0,
  ...
  return (
    <View
      ...
      <Button
        ...
        wrapperStyle={{paddingHorizontal: 32, flex: 1 / 2}}
        title="Next"
        ...
        onPress={() => {
          ...
          navigation.navigate('Protected', {screen: 'VerifySOSPIN'});
        }}
      />
